...
// C:/Users/10156/.dsh/plugins/whale-girl/lib/client/index.mjs
var index_exports = {};
...
// C:/Users/10156/.dsh/plugins/whale-girl/lib/src/snapshot.mjs
var TURN_COMPLETED_MS = 4e3;

// C:/Users/10156/.dsh/plugins/whale-girl/lib/client/logic.mjs
...
// C:/Users/10156/.dsh/plugins/whale-girl/lib/client/character.mjs
...
// C:/Users/10156/.dsh/plugins/whale-girl/lib/src/routes.mjs
...
function apply(ctx = {}) {
  ...
  bgBtn.textContent = "\u{1F5BC}\uFE0F \u80CC\u666F";
  ...
  bgImportBtn.textContent = "\u{1F4C1} \u5BFC\u5165\u56FE\u7247";
  ...
  const applyBackground = () => {
    ...
    for (const name2 of BG_VARS) {
      if (active) document.body.style.setProperty(name2, "transparent");
      else document.body.style.removeProperty(name2);
    }
  };
  const bgObserver = new MutationObserver(() => {
    ...
    for (const name2 of BG_VARS) {
      ...
      if (document.body.style.getPropertyValue(name2) !== want) {
        if (active) document.body.style.setProperty(name2, "transparent");
        else document.body.style.removeProperty(name2);
      }
    }
  ...
  bgFileInput.addEventListener("change", async () => {
    ...
    try {
      ...
      bgState = { dataUrl, transparency: 0 };
      saveBg();
      applyBackground();
      renderBgPanel();
    } catch {
  ...
  const dispose = () => {
    ...
    bgPanel.remove();
    bgFileInput.remove();
    for (const name2 of BG_VARS) document.body.style.removeProperty(name2);
    host.remove();
    style.remove();
  };
  return dispose;
